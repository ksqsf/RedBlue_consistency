...
public abstract class URLGenerator
{
  ...
  /**
   * 
   * Returns the name of the Auction Manager script according to the servlet implementation
   * @return Auction Manager script
   * */
  public abstract String AuctionManagerScript();
  
  
  /**
   * 
   * Returns the name of the get auctions ready for close script according to the servlet implementation
   * @return get auctions ready for close script
   * */
  public abstract String GetAuctionsReadyForCloseScript();
  
  /**
   * 
   * Returns the name of the close auction according to the servlet implementation
   * @return close auction script
   * */
  public abstract String CloseAuctionScript();
                         ...
                         String email, String password,String regionName)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
    	...
    	System.out.println("Error while encoding register user page URL: " + e1.getMessage());
    	return null;
    }
  }
  ...
  public URL browseItemsInCategory(int categoryId, String categoryName, int page, int nbOfItems)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'browse all items in a category' script URL: "+e1.getMessage());
        return null;
    }
  }
  ...
  public URL browseCategoriesInRegion(String regionName)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'browse all categories in a region' script URL: "+e1.getMessage());
        return null;
    }
  }
  ...
  public URL browseItemsInRegion(int categoryId, String categoryName, int regionId, int page, int nbOfItems)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'browse all items in a category in a region' script URL: "+e1.getMessage());
        return null;
    }
  }
  ...
  public URL putComment(int itemId, int toId, String name, String pwd)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'Put Comment on another user' script URL: "+e1.getMessage());
        return null;
    }
  }   
  ...
  public URL storeComment(int itemId, int toId, int fromId, int rating, String comment)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding StoreComment script URL: "+e1.getMessage());
        return null;
    }
  }   
  ...
  public URL putBid(int itemId, String name, String pwd)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'Put bid on an Item' script URL: "+e1.getMessage());
        return null;
    }
  }
  ...
  public URL buyNow(int itemId, String name, String pwd)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'Buy Now' script URL: "+e1.getMessage());
        return null;
    }
  }   
  ...
  public URL selectCategoryToSellItem(String name, String pwd)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'Select category to sell item' script URL: "+e1.getMessage());
        return null;
    }
  }
                         ...
                         int quantity, int userId, int categoryId)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'Register item' script URL: "+e1.getMessage());
        return null;
    }
  }
  ...
  public URL aboutMe(String name, String pwd)
  {
    ...
    catch (java.net.MalformedURLException e)
    {
      ...
      return null;
        ...
        System.out.println("Error while encoding 'About Me' script URL: "+e1.getMessage());
        return null;
    }
  }
  
  public URL getAuctionsReadyForClose(int maxOpenItemId){
	  try{
		  URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+GetAuctionsReadyForCloseScript() + "?maxOpenItemId="+maxOpenItemId);
	      return url;
	  }catch (java.net.MalformedURLException e){
	      System.out.println("Error while generating 'GetAuctionsReadyForClose' script URL: "+e.getMessage());
	      return null;
	  }
  }
  
  public URL closeAuction(int itemId){
	  try{
		  URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+CloseAuctionScript() + "?itemId=" + itemId);
	      return url;
	  }catch (java.net.MalformedURLException e){
	      System.out.println("Error while generating 'Close auction' script URL: "+e.getMessage());
	      return null;
	  }
  }
...
//=====================================================
  ...
  public String getAuctionManagerURL(){
	  return protocol+"://"+webSiteName+":"+webSitePort+scriptPath+"/"+AuctionManagerScript();
  }
