...
public class RUBiSProperties
{
  ...
  /*
   * The following bit is added by Cheng for generating
   * a list of random open items in a fast manner
   */
  private Integer maxOpenItemId; 
  ...
  public URLGenerator checkPropertiesFileAndGetURLGenerator()
  {
    try
    {
      ...
      System.out.print("Max id of the open items               : ");
      maxOpenItemId = new Integer(getProperty("database_max_id_for_open_items"));
      System.out.println(maxOpenItemId+"<br>");
  ...
  /**
   * Get the max id of open items.
   *
   * @return max id of open items (auction date has not been expired)
   */
  public int getMaxOpenItemId(){
	  return maxOpenItemId.intValue();
  }
