...
public class URLGeneratorServlets extends URLGenerator
{
  ...
  public String AuctionManagerScript()
  {
	  return "edu.rice.rubis.servlets.AuctionManager";
  }
  
  public String GetAuctionsReadyForCloseScript(){
	  return "edu.rice.rubis.servlets.GetAuctionsReadyForClose";
  }
  
  public String CloseAuctionScript(){
	  return "edu.rice.rubis.servlets.CloseAuction";
  }
}
