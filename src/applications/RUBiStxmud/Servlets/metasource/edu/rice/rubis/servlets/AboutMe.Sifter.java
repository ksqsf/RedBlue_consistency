 ...
 */
  ...
  private boolean listItem(Integer userId, TxMudConnection conn, ServletPrinter sp)
  {
    ...
    catch (Exception e)
    {
      ...
      Database.closeConnection(currentStmt, conn);
      return false;
    }
    ...
    catch (Exception e)
    {
      ...
      Database.rollback(conn);
      Database.closeConnection(pastStmt, conn);
      return false;
    }
  ...
  private boolean listBoughtItems(Integer userId, PreparedStatement stmt, TxMudConnection conn, ServletPrinter sp)
  {
    ResultSet buy = null;
  ...
  private boolean listWonItems(Integer userId, PreparedStatement stmt, TxMudConnection conn, ServletPrinter sp)
  {
    int sellerId, itemId;
  ...
  private boolean listComment(Integer userId, PreparedStatement stmt, TxMudConnection conn, ServletPrinter sp)
  {
    ResultSet rs = null;
    String date, comment;
    int authorId;
  ...
  private boolean listBids(Integer userId, String username, String password, PreparedStatement stmt, TxMudConnection conn, ServletPrinter sp)
  {
    ...
    throws IOException, ServletException
  {
      ...
      || (password != null && password != ""))
    {
      ...
      if (id == -1)
      {
        ...
        Database.commit(conn);
        Database.closeConnection(null,conn);
        return;
      }
    ...
    if (connAlive) {
    	Database.commit(conn);//commit at the end of this transaction
        Database.closeConnection(stmt, conn);
    }
    sp.printHTMLfooter();
  }
