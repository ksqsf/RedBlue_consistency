 ...
 */
    ...
    throws IOException, ServletException
  {
    ...
    try
    {
      ...
      //set shadow operation
      try{
  	    DBRUBISShdRegisterItem dRIM = DBRUBISShdRegisterItem.createOperation(itemId, name, description,
                initialPrice, quantity, reservePrice, buyNow, startDate, endDate, userId, categoryId);
  	    conn.setShadowOperation(dRIM, 0);
      }catch (IOException e){
  		// TODO Auto-generated catch block
  		e.printStackTrace();
      }
