 ...
 */
    ...
    throws IOException, ServletException
  {
    ...
    int buyNowId = Config.BuyNowIDFactory.addAndGet(Config.TotalProxies);
    try
    {
      stmt =
        conn.prepareStatement(
      ...
      if(quantity == 0){
    	  //shadow buynow1
          try{
      	    DBRUBISShdStoreBuyNow1 dSBN1 = DBRUBISShdStoreBuyNow1.createOperation(buyNowId,userId.intValue(),itemId.intValue(),qty,quantity,now);
      	    conn.setShadowOperation(dSBN1, 1);
          }catch (IOException e){
      		// TODO Auto-generated catch block
      		e.printStackTrace();
          }
          ...
          try{
        	    DBRUBISShdStoreBuyNow2 dSBN2 = DBRUBISShdStoreBuyNow2.createOperation(buyNowId,userId.intValue(),itemId.intValue(),qty,quantity,now);
        	    conn.setShadowOperation(dSBN2, 1);
            }catch (IOException e){
        		// TODO Auto-generated catch block
        		e.printStackTrace();
            }
