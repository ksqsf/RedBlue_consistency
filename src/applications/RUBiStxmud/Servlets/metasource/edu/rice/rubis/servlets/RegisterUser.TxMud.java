 ...
 */
    ...
    throws IOException, ServletException
  {
    ...
    int uId = Config.UserIDFactory.addAndGet(Config.TotalProxies);
    try
    {
      stmt =
    ...
    try{
    	DBRUBISShdRegisterUser1 dRU  = DBRUBISShdRegisterUser1.createOperation(uId,firstname,lastname,nickname,password,email,now,regionId);
	    conn.setShadowOperation(dRU, 1);
    }catch (IOException e){
		// TODO Auto-generated catch block
		e.printStackTrace();
    }
