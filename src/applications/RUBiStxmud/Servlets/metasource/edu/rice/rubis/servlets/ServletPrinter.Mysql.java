...
public class ServletPrinter
{
  ...
  void printItemHeaderForClose()
  {
    out.println(
      "<TABLE border=\"1\" summary=\"List of items\">"
        + "<THEAD>"
        + "<TR><TH>Designation<TH>Max bid<TH>Number of bids<TH>End Date<TH>Close Now"
        + "<TBODY>");
  }
		    ...
		    try
		    {
		      out.println(
		        "<TR><TD><a href=\"edu.rice.rubis.servlets.ViewItem?itemId="
		          ...
		          + "<TD>"
		          + endDate
		          + "<TD><a href=\"edu.rice.rubis.servlets.CloseAuction?itemId="
		          + itemId
		          + "\"><IMG SRC=\"/rubis_servlets/close_now.png\" height=22 width=90></a>");
		    }
		    catch (Exception e)
		    {
		      out.println("Unable to print Item (exception: " + e + ")<br>");
