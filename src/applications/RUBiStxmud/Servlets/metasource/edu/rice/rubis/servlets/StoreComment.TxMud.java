 ...
 */
    ...
    throws IOException, ServletException
  {
    ...
    try
    {
      ...
      int commentId = Config.CommentIDFactory.addAndGet(Config.TotalProxies);
      try
      {
        stmt =
      ...
      try
      {
        ...
        if (urs.first())
        {
          ...
          stmt.executeUpdate();
          try{
        	    DBRUBISShdStoreComment2 dSC2 = DBRUBISShdStoreComment2.createOperation(commentId,fromId,toId,itemId,rating,now,comment);
        	    conn.setShadowOperation(dSC2, 0);
            }catch (IOException e){
            ...
            try{
        	    DBRUBISShdStoreComment1 dSC1 = DBRUBISShdStoreComment1.createOperation(commentId,fromId,toId,itemId,rating,now,comment);
        	    conn.setShadowOperation(dSC1, 0);
            }catch (IOException e){
        		// TODO Auto-generated catch block
        		e.printStackTrace();
          }
