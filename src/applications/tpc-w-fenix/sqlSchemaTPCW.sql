@AOSETTABLE CREATE TABLE address(
	@NORMALINTEGER addr_id int not null AUTO_INCREMENT, 
...
@AUSETTABLE CREATE TABLE customer ( 
	@NORMALINTEGER c_id int not null AUTO_INCREMENT, 
...
@AOSETTABLE CREATE TABLE orders ( 
	@NORMALINTEGER o_id int not null AUTO_INCREMENT, 
...
@AUSETTABLE CREATE TABLE shopping_cart ( 
	@NORMALINTEGER sc_id int not null AUTO_INCREMENT, 
