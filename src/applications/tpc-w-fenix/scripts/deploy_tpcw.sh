...
DATABASETGZ="mysql-5.5.18.zero.lc0-0.50eb10kitem.txmud.iblog.chengli.tgz"
#DATABASE
DBPORT=53306
DBUSER="sa"
DBUSERPW=""
...
#TXM_PROXY[0]="139.19.158.42"
#TXM_COORDINATOR[0]="139.19.158.43"
#TXM_STORAGESHIM[0]="139.19.158.44"
#TXM_USER[0]="139.19.158.45"
TXM_PROXY[0]="139.19.158.1"
TXM_COORDINATOR[0]="139.19.158.3"
TXM_STORAGESHIM[0]="139.19.158.9"
TXM_USER[0]="139.19.158.5"
####DATACENTER 1
...
TXM_DATABASE[1]="139.19.158.46"  
TXM_PROXY[1]="139.19.158.7"
TXM_COORDINATOR[1]="139.19.158.8"
TXM_STORAGESHIM[1]="139.19.158.9"
TXM_USER[1]="139.19.158.10"
#####################################
...
for ((i=0;i<$DATACENTERNUM;i++)) do
	...
	CMD_CONFIGURE[$i]="cd $TPCW_ROOT && ant clean dist -DoutputDir=$TPCW_OUTPUTDIR -DdcId=$i \
			 ...
			 -Dthinktime=$TPCW_THINKTIME -DdcCount=$DATACENTERNUM -DssId=0 -DdbFile=$DATABASEXMLFILENAME -DscratchpadNum=20"
done;
if [ -n $2 ]
	then
		for((i=0;i<$DATACENTERNUM;i++)) do
