...
TXM_DATABASE="ec2-46-51-143-169.eu-west-1.compute.amazonaws.com"  
TXM_PROXY="ec2-46-137-15-4.eu-west-1.compute.amazonaws.com"
TXM_USER="ec2-46-137-69-93.eu-west-1.compute.amazonaws.com"
...
TOPOLOGYXMLFILENAME="tpcwtxmud_redblue.xml"
DATABASEXMLFILENAME="tpcwtxmud_redbluedb.xml"
...
<databases dbNum="1">
        <database dcId="0" dbId="0" dbHost="$TXM_DATABASE" dbPort="53306" dbUser="sa" dbPwd=""
                ...
                tableLWW="address,author,cc_xacts,country,customer,item,order_line,shopping_cart_line" 
                talbeOps=""
                redTable="address,author,cc_xacts,country,customer,item,order_line,shopping_cart_line" 
        		blueTable="orders,shopping_cart" 
