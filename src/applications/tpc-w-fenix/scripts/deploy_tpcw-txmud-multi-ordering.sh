...
ITEM=10000 
TPCW_MIX=3 #1 browsing, 2 shopping, 3 ordering
TPCW_WARMUPTIME=60
...
###############AMAZON###############
####DATACENTER 0
TXM_DATABASE[0]="ec2-50-17-44-3.compute-1.amazonaws.com"
TXM_PROXY[0]="ec2-174-129-134-62.compute-1.amazonaws.com"
TXM_COORDINATOR[0]="ec2-174-129-126-158.compute-1.amazonaws.com"
TXM_STORAGESHIM[0]="ec2-50-16-126-6.compute-1.amazonaws.com"
TXM_USER[0]="ec2-50-19-45-23.compute-1.amazonaws.com"
####DATACENTER 1
TXM_DATABASE[1]="ec2-79-125-92-113.eu-west-1.compute.amazonaws.com"
TXM_PROXY[1]="ec2-79-125-31-156.eu-west-1.compute.amazonaws.com"
TXM_COORDINATOR[1]="ec2-79-125-91-250.eu-west-1.compute.amazonaws.com"
TXM_STORAGESHIM[1]="ec2-46-51-152-74.eu-west-1.compute.amazonaws.com"
TXM_USER[1]="ec2-46-137-42-181.eu-west-1.compute.amazonaws.com"
############THOR MPI################
####DATACENTER 0
