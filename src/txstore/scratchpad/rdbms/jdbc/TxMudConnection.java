package txstore.scratchpad.rdbms.jdbc;
import util.Debug;
...
import txstore.scratchpad.rdbms.util.DBGenericOperation;
...
import txstore.util.TimeMeasurement;
	...
	implements Connection
{
	...
	public void commit() throws SQLException {
		...
		/*if(!op.isEmptyShadowOperation()){
				TimeMeasurement.outputLatencyString(startTime, TimeMeasurement.EXECUTION, 
					TimeMeasurement.UPDATE);
		}else{
				TimeMeasurement.outputLatencyString(startTime, TimeMeasurement.EXECUTION, 
					TimeMeasurement.READONLY);
		}
		
		long commitStartTime = TimeMeasurement.getCurrentTimeInNS();*/
		...
		/*if(!op.isEmptyShadowOperation()){
				TimeMeasurement.outputLatencyString(commitStartTime, TimeMeasurement.COMMIT, 
					TimeMeasurement.UPDATE);
		}else{
				TimeMeasurement.outputLatencyString(commitStartTime, TimeMeasurement.COMMIT, 
					TimeMeasurement.READONLY);
	...
	implements Statement
{
	...
	public int executeUpdate(String arg0) throws SQLException {
		...
		DBUpdateResult res = DBUpdateResult.createResult(  proxy.execute( DBSingleOperation.createOperation( arg0), txId).getResult());
		return res.getUpdateResult();
	}
	...
	public class TxMudResultSet implements ResultSet
	{
		...
		TxMudResultSet( DBSelectResult res) {
			this.res = res;
		}
		...
		public void beforeFirst() throws SQLException {
			System.out.println(" // TODO Auto-generated method stub 604");
...
//		}
		...
		public int executeUpdate() throws SQLException {
			...
			DBUpdateResult res = DBUpdateResult.createResult(  proxy.execute( DBSingleOperation.createOperation( this.generateStatement()), txId).getResult());
			return res.getUpdateResult();
		}
