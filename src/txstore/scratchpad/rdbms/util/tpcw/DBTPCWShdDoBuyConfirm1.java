...
/**
 * Red transaction, increased + address
 * 
 * @author chengli
 *
 */
public class DBTPCWShdDoBuyConfirm1 extends DBShadowOperation {
	int shopping_id;
	int customer_id;
	...
	public static DBTPCWShdDoBuyConfirm1 createOperation(
		...
		return new DBTPCWShdDoBuyConfirm1(baos.toByteArray(), shopping_id, customer_id, 
	...
	public static DBTPCWShdDoBuyConfirm1 createOperation(		int shopping_id, int customer_id, 
	...
	protected DBTPCWShdDoBuyConfirm1(byte[] arr, 	int shopping_id, int customer_id, 
			String addr_street1,	String addr_street2,	String addr_city, String addr_state,
			String addr_zip, int country_id,
			int o_id, long o_date, double sc_sub_total, double sc_total, long o_ship_date, int customer_addr_id, int ship_addr_id,
			Vector<Integer> it_id_v, Vector<Integer> it_q_v, Vector<String> it_c_v, Vector<Integer> it_s_v, String cc_type,
	...
	public DBTPCWShdDoBuyConfirm1(byte[] arr) {
		super(arr);
	...
	public void executeShadow(IDefDatabase iDefDatabase) {
		// TODO Auto-generated method stub
		Debug.println("Execute shadow doBuyConfirm increase + address");
