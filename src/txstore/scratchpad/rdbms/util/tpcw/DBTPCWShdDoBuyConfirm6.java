 ...
 *
 */
public class DBTPCWShdDoBuyConfirm6 extends DBShadowOperation {
	int shopping_id;
	int customer_id;
	...
	public static DBTPCWShdDoBuyConfirm6 createOperation(
		...
		return new DBTPCWShdDoBuyConfirm6(baos.toByteArray(), shopping_id, customer_id, 
				o_id,  o_date,  sc_sub_total,  sc_total, o_ship_date, customer_addr_id, ship_addr_id,
				cc_type, cc_number, cc_name, cc_expiry, cc_pay_date, shipping, c_discount);

	}

	public static DBTPCWShdDoBuyConfirm6 createOperation(		int shopping_id, int customer_id, 
			int o_id, long o_date, double sc_sub_total, double sc_total, long o_ship_date, int customer_addr_id, int ship_addr_id,
			String cc_type,long cc_number, String cc_name, long cc_expiry, long cc_pay_date, String shipping, double c_discount) throws IOException {
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		DataOutputStream dos = new DataOutputStream(baos);
	...
	protected DBTPCWShdDoBuyConfirm6(byte[] arr, 	int shopping_id, int customer_id, 
			int o_id, long o_date, double sc_sub_total, double sc_total, long o_ship_date, int customer_addr_id, int ship_addr_id,
			String cc_type, long cc_number, String cc_name, long cc_expiry, long cc_pay_date, String shipping, double c_discount) {
		super(arr);
	...
	public DBTPCWShdDoBuyConfirm6(byte[] arr) {
		super(arr);
	...
	public void executeShadow(IDefDatabase iDefDatabase) {
		// TODO Auto-generated method stub
		Debug.println("execute shadow doBuyConfirm no update + no address");
		//insert into orders
