...
/**
 * Blue transactiondecreased + no new address
 * 
 * @author chengli
 *
 */

public class DBTPCWShdDoBuyConfirm4 extends DBShadowOperation {
	int shopping_id;
	int customer_id;
	//order
	int o_id;
	...
	//modify stock
	Vector<Integer> it_s_v; //stock delta
	...
	public static DBTPCWShdDoBuyConfirm4 createOperation(
		...
		return new DBTPCWShdDoBuyConfirm4(baos.toByteArray(), shopping_id, customer_id, 
	...
	public static DBTPCWShdDoBuyConfirm4 createOperation(		int shopping_id, int customer_id, 
	...
	protected DBTPCWShdDoBuyConfirm4(byte[] arr, 	int shopping_id, int customer_id, 
			int o_id, long o_date, double sc_sub_total, double sc_total, long o_ship_date, int customer_addr_id, int ship_addr_id,
			Vector<Integer> it_id_v, Vector<Integer> it_q_v, Vector<String> it_c_v, Vector<Integer> it_s_v, String cc_type,
	...
	public DBTPCWShdDoBuyConfirm4(byte[] arr) {
		super(arr);
	...
	public void executeShadow(IDefDatabase iDefDatabase) {
		// TODO Auto-generated method stub
		Debug.println("execute shadow doBuyConfirm decrease + no address");
		//insert into orders
