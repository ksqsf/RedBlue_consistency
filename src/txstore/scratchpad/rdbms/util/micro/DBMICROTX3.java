package txstore.scratchpad.rdbms.util.micro;
...
import txstore.scratchpad.rdbms.IPrimaryExec;
...
public class DBMICROTX3 extends DBShadowOperation{
	...
	protected DBMICROTX3(byte[] arr) {
		super(arr);
	}
	public static DBMICROTX3 createOperation(DataInputStream dis) throws IOException {
		...
		return new DBMICROTX3( baos.toByteArray(), tN, pK, pKv, fD, vL);
		
	}
	public static DBMICROTX3 createOperation(String tN, String pK, String pKv, String fD, String vL) throws IOException {
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		DataOutputStream dos = new DataOutputStream( baos);
	...
	protected DBMICROTX3(byte[] arr, String tN, String pK, String pKv, String fD, String vL) {
		super(arr);
		this.tableName = tN;
		this.primaryKey = pK;
	...
	public void executeShadow(IDefDatabase store) {
		...
		Debug.print("Shadow execution of micro3\n");
		try{
	    	...
	    	System.err.println("Exception from shadow operation of micro3");
	    	e.printStackTrace();
	    	Debug.kill(e);
	    }
	}
