...
public class TransactionRecord{
  ...
  public void setShadowOp(Operation op){
	  shadowOp = op;
	  //testing the code should be removed
	  /*if(!readOnly) {
		  //if the shadow operation is an empty one, problem stop
		  byte opType = op.getOperation()[1];
		  if(opType == DBShadowOperation.OP_SHD_TPCW_NONE) {
			  System.out.println("you have to check this transaction " + this.toString());
			  System.exit(-1);
		  }
	  }*/
  }
